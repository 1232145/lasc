        ...
        <div className="mb-16">
          ...
          <div className="space-y-4 text-stone-700 leading-relaxed">
            ...
            <p>
              ...
              purchased the building at <strong className="text-orange-700">10 E Locust Street</strong>, and
        ...
        <div className="mb-12">
          ...
          {board && board.length > 0 ? (
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
              {board.map((member) => (
                <div key={member.id} className="bg-white p-4 rounded-lg shadow-md border border-orange-200 hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-stone-500">Board information coming soon.</p>
          )}
        </div>
      </div>
    </section>
